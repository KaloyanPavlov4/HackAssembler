...
public class Code {
    private final Map<String, String> comp = Map.ofEntries(Map.entry("0", "0101010"), Map.entry("1", "0111111"), Map.entry("-1","0111010"),
            ...
            Map.entry("!M","1110001"), Map.entry("-M","1110011"), Map.entry("M+1","1110111"), Map.entry("M-1","1110111"),
    ...
    private final Map<String, String> jump = Map.ofEntries(Map.entry("JGT","001"), Map.entry("JEQ","010"),Map.entry("JGE","001"),
